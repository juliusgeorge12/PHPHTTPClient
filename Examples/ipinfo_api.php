 ...
 * this example demonstrate how to use the 
 * PHPHTTPClient to get the country name
 * from ip-info.io api  using the ip address
...
//create the httclient object
 ...
 //$http->send()
  ...
  $http->open('http://ipinfo.io/216.58.223.238/json' , 'get');
